      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <svg viewBox="0 0 30 30" className="w-12 h-12" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="blueSphereGrad" cx="35%" cy="35%" r="65%" fx="35%" fy="35%">
                    <stop offset="0%" stopColor="#A5D8FF" />
                    <stop offset="40%" stopColor="#228BE6" />
                    <stop offset="100%" stopColor="#0B3B60" />
                  </radialGradient>
                </defs>
                <circle cx="15" cy="15" r="13" fill="url(#blueSphereGrad)" />
              </svg>
              <motion.div
          ...
          >
            ...
            <div className="flex items-center gap-2" style={{ color: 'rgba(253, 186, 116, 0.4)' }}>
              <svg viewBox="0 0 30 30" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="blueSphereGradSmall" cx="35%" cy="35%" r="65%" fx="35%" fy="35%">
                    <stop offset="0%" stopColor="#A5D8FF" />
                    <stop offset="40%" stopColor="#228BE6" />
                    <stop offset="100%" stopColor="#0B3B60" />
                  </radialGradient>
                </defs>
                <circle cx="15" cy="15" r="13" fill="url(#blueSphereGradSmall)" />
              </svg>
